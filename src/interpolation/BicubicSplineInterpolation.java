...
public class BicubicSplineInterpolation {
    ...
    public static double calculate(Matrix vectorY, double a, double b, boolean imageResizing) {
        ...
        try {
            if (imageResizing) {
                Matrix inversedMatrixX = InputUtils.readMatrixFromFile("src/interpolation/ImageResizingMatrix.txt");
                vectorA = inversedMatrixX.multiplyMatrix(vectorY);
            }
            else {
                matrixX = InputUtils.readMatrixFromFile("src/interpolation/MatrixX.txt");
